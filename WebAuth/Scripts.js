...
function browserDetection() { 
	if(navigator.userAgent.indexOf("Chrome") != -1 ){
		document.getElementById("browser").innerHTML=" <h1>Your browser is Chrome</h1>";
    }
...
function timeDigtal(){
    ...
    document.getElementById("digtime").innerHTML="<h1>TIME IS: " + hours + ":" + minutes + " " + ":" + seconds + " " + "</h1>";
